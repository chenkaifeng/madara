            ...
            <div class="pull-left">
                <div class="form-group col-xs-12">
                    ...
                    <shiro:hasPermission name="sys:user:unfreeze">
                        <a class="btn btn-success" @click="unfreeze"><i class="fa fa fa-info-circle"></i>&nbsp;解冻</a>
                    </shiro:hasPermission>
                    ...
                    <shiro:hasPermission name="sys:user:resetPassword">
                        <a class="btn btn-success" @click="resetPassword"><i class="fa fa fa-info-circle"></i>&nbsp;重置密码</a>
                    </shiro:hasPermission>
                </div>
            </div>
            <div class="clearfix"></div>
    ...
    <div v-show="!showList" class="panel panel-default">
        ...
        <form class="form-horizontal" style="width:550px;padding-top:20px;">
            ...
            <div class="form-group">
                ...
                <input type="button" class="btn btn-success" @click="addOrUpdate" value="确定"/>
